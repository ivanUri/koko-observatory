...
# API key duoc nhung truc tiep theo yeu cau.
# Khong chia se hoac commit file nay len Git.
APIKEY='sk-u2HNJmXVMsLdyMlewfQypObqaVprTxqhC'
...
export ANTHROPIC_MODEL="nghi/claude-sonnet-5"
export ANTHROPIC_DEFAULT_OPUS_MODEL="nghi/claude-opus-5"
export ANTHROPIC_DEFAULT_SONNET_MODEL="nghi/claude-sonnet-5"
export ANTHROPIC_DEFAULT_HAIKU_MODEL="nghi/claude-haiku-4.5"
